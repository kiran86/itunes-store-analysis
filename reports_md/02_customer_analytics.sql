...
\echo '### Q1: Which customers have spent the most money on music?'
...
\echo '### Q2: What is the average customer lifetime value?'

SELECT
    ROUND(AVG(total_revenue), 2) AS avg_customer_lifetime_value
FROM customer_summary;

\echo '### Q3: How many customers have made repeat purchases versus one-time purchases?'
...
\echo '### Q4: Which country generates the most revenue per customer?'
SELECT
    country,
...
\echo '### Q5: Which customers haven not made a purchase in the last 6 months?'
